 ...
 * Use the {@link TerlarisFragment#newInstance} factory method to
...
public class TerlarisFragment extends Fragment {
     ...
     * @return A new instance of fragment TerlarisFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TerlarisFragment newInstance(String param1, String param2) {
        TerlarisFragment fragment = new TerlarisFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_terlaris, container, false);

        txtNoResult = view.findViewById(R.id.txtNoResult);
        rvProducts = view.findViewById(R.id.rvTerlaris);
        rvProducts.setLayoutManager(new GridLayoutManager(getContext(), 2));

        ApiService apiService = ApiClient.getClient().create(ApiService.class);
        apiService.getTerlaris().enqueue(new Callback<List<Produk>>() {
            @Override
