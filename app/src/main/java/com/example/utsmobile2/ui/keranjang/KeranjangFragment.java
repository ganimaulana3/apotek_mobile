...
public class KeranjangFragment extends Fragment implements CartAdapter.OnQuantityChangedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        cardViewTotal = root.findViewById(R.id.cardViewTotal);
    ...
    private void updateTotalHarga() {
        ...
        currentSubtotal = total; // Simpan nilai subtotal saat ini
