...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jul 2025 pada 13.39
...
(1, 'Paracetamol 500mg', 'Obat Bebas', 'Obat pereda demam dan nyeri', 5000, 0, 'Paracetamol_500mg.jpeg'),
...
(6, 'Diapet', 'Suplemen', 'Obat herbal untuk diare', 6500, 0, 'Diapet.jpeg'),
...
INSERT INTO `tbl_detail_order` (`trans_id`, `kode_brg`, `harga_jual`, `qty`, `bayar`) VALUES
(2, '1', 5000, 1, 5000),
(2, '4', 4000, 1, 4000),
(3, '1', 5000, 2, 10000),
(4, '1', 5000, 1, 5000),
...
INSERT INTO `tbl_order` (`trans_id`, `nm_penerima`, `email`, `tgl_order`, `subtotal`, `ongkir`, `total_bayar`, `alamat_kirim`, `telp_kirim`, `kota`, `provinsi`, `lamakirim`, `kodepos`, `metodebayar`, `buktibayar`, `status`) VALUES
(3, '', 'gani@gmail.com', '2025-06-29', 10000, 70000, 80000, 'Randegan', '08237487298', 'Kota Banjar', 'Jawa Barat', '5-6 hari', '45321', 2, 'IMG-20230802-WA0000.jpg', 2),
(4, '', 'gani@gmail.com', '2025-06-30', 9000, 55000, 64000, 'Randegan 1 RT02 RW01', '0823173306748', 'Kota Bekasi', 'Jawa Barat', '3-4 hari', '568357', 1, 'IMG_20240811_15541900.jpg', 0),
(5, 'Novan', 'gani@gmail.com', '2025-07-06', 5000, 50000, 55000, 'Pemalang', '084567931548', 'Kabupaten Pemalang', 'Jawa Tengah', '4-5 hari', '58496', 2, 'IMG_20240811_15541900.jpg', 1);
...
INSERT INTO `tbl_pelanggan` (`id`, `nama`, `alamat`, `kota`, `provinsi`, `kodepos`, `telp`, `email`, `password`, `foto`) VALUES
...
(24, 'Gani Maulanaa', 'Jl. Raya Nomor 123', 'Bandung', 'Jawa Barat', '40111', '081234567890', 'gani@gmail.com', '202cb962ac59075b964b07152d234b70', 'IMG_6862f10d335ea.jpg'),
...
--
ALTER TABLE `tbl_viewer`
  MODIFY `id_viewer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
